...
function NewUser() {
  ...
  return (
    <div className="  px-6 p-4 w-full flex flex-col ">
      ...
      <div className=" border-[1px] border-dotted border-gray-300 p-2  mt-4 ">
        <div className="bg-gray-300 p-2  bg-opacity-50 text-white text-sm font-semibold  px-4  ">
          ...
          <div className="flex flex-col md:flex-row">
            <div className="flex mb-4 w-fit  ">
              {!selectedImage && (
                <label
                  htmlFor="image"
                  className=" cursor-pointer transition-all duration-300 hover:bg-gray-600 hover:bg-opacity-30 relative mr-2 w-[200px] h-[200px] border-[1px] border-dashed border-gray-200 flex items-center justify-center flex-col"
                >
                  {" "}
                  <FontAwesomeIcon
                    icon={faImages}
                    className=" text-[70px] text-white  opacity-70  "
                  />
              ...
              <div className="flex flex-col md:flex-row">
                <div className=" w-full  grid grid-cols-2 gap-x-8 gap-y-3 px-4">
                  ...
                  <div className="relative z-0 mb-6 w-full flex group items-end ">
                    <select
                      className="block w-full text-gray-300   px-0  text-sm  bg-transparent border-b-[1px] pb-2 border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-600 peer"
                      id=""
                      name="category"
                    >
