  ...
  return (
    <>
      ...
      <div className=" container mx-auto px-2 flex  relative w-full  mt-2 outline-4">
        <button
          className=" absolute top-2 right-6 bg-gray-500 p-2 px-3 text-white text-sm rounded-sm transition-all duration-300 hover:translate-x-1 hover:bg-gray-600"
          onClick={handleClick}
        >
          <FontAwesomeIcon icon={faKey} className="mr-2" /> Change password
        </button>
        <div className=" mt-[70px] w-full md:w-[90%] relative flex flex-col p-2 gap-4 justify-center items-center border-[1px] border-dotted border-gray-300">
          <div className="   p-2 bg-gray-400 bg-opacity-40 text-white w-full font-semibold text-[13px]">
          ...
          >
            <div className="w-fit ">
              <div className="flex mb-4 w-fit  ">
                {!selectedImage && (
                  <label
                    htmlFor="image"
                    className=" cursor-pointer transition-all duration-300 hover:bg-gray-100 relative mr-2 w-[200px] h-[200px] border-[1px] border-dashed border-gray-200 flex items-center justify-center flex-col"
                  >
                    {" "}
                    <ImageWithBlurhash
                      imageUrl={
                    ...
                    />
                    <p className=" text-xs p-4 w-full  text-white absolute  bottom-0  left-0  bg-gray-500 bg-opacity-50 backdrop-blur-sm h-fit transition-all duration-300 group-hover:-translate-y-[100%]  ">
                ...
                {selectedImage && (
                  <div className=" relative w-[200px] h-fit border-[1px] border-dashed border-gray-200 p-4 py-2">
            ...
            <div className=" w-full grid grid-cols-2 gap-x-8 gap-y-6 mt-4">
              <div className="relative z-0 mb-6 w-full group">
                <input
                  type="text"
                  name="firstName"
                  className="block py-2.5 px-0 w-full text-sm text-gray-100 bg-transparent border-0 border-b-[1px] border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-gray-200 peer"
                  placeholder=" "
              ...
              <div className="w-full flex justify-end col-span-2 ">
                <button
                  ...
                  }  focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm w-fit sm:w-auto px-5 py-2.5 text-center  `}
                >
                  {!isSubmit ? (
                    "Update"
                  ) : (
      ...
      >
        <form
          ...
          className=" relative w-[80%] md:w-1/2  p-4 shadow-lg rounded-md border-[0px] border-gray-100 py-8 bg-gray-400 bg-opacity-30  backdrop-blur-md "
        >
          <FontAwesomeIcon
            icon={faXmark}
            onClick={handleCloseModal}
            title="Close"
            className=" cursor-pointer p-2 absolute -right-3 -top-3 aspect-square bg-gray-600 text-white text-[22px] font-extrabold  rounded-full transition-all duration-300 hover:bg-gray-400 shadow-md  hover:origin-center hover:rotate-[360deg]  "
          />
          <div className="relative z-0 mb-6 w-full group">
            <input
              type="password"
          ...
          <div className="w-full flex justify-end ">
            <button
              type="submit"
              className="  text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm w-fit sm:w-auto px-5 py-2.5 text-center d"
            >
              Update
            </button>
          </div>
